#ifndef MUDOS_NG_SRC_BASE_INTERNAL_STRUTILS_CC_EGCSTRINGVIEW_H_
#define MUDOS_NG_SRC_BASE_INTERNAL_STRUTILS_CC_EGCSTRINGVIEW_H_
...
#endif  // MUDOS_NG_SRC_BASE_INTERNAL_STRUTILS_CC_EGCSTRINGVIEW_H_
